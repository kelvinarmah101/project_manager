...
import { Menu, Box, FileSearch, HelpCircle, Newspaper, SearchCheck, Upload, User, Grid2X2, GridIcon, Grid, Grid2x2, LayoutGrid } from 'lucide-react';
    ...
    <div>
        <main className={`dashboard flex bg-gray-100 ${menu && "active"}`}>
            ...
            <div className="right ">
                ...
                <div className="content p-10 max-[500px]:p-5 overflow-y-scroll" style={{height: 'calc(100vh - 70px)'}}>
                    <Outlet />
                </div>  
            </div>
        </main>
